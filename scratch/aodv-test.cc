...
AodvExample::CreateNodes()
{
    ...
    AnimationInterface::SetConstantPosition (nodes.Get (1), -30, 30);  
    AnimationInterface::SetConstantPosition (nodes.Get (2), -30, -30); 
    AnimationInterface::SetConstantPosition (nodes.Get (3), 80, 30);
    AnimationInterface::SetConstantPosition (nodes.Get (4), 80, -30);
    AnimationInterface::SetConstantPosition (nodes.Get (5), 25, 30);
    AnimationInterface::SetConstantPosition (nodes.Get (6), 50, 0);
